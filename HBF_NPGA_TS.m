function [SE_ts,W_rf]=HBF_NPGA_TS(params_pga,params_ts,Pb,Ns,N_rf,H_all,InI,noise_power,episilon,obj_fun,obj_fun_pg)
[Nr,Nt,Nc]=size(H_all);
Np=10;
power_avr=Pb/Ns;
F_ini=rand(Nt,N_rf);
